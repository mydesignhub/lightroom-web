...
const KNOWLEDGE_BASE = [
    ...
    // ---------------------------------------------------------
    // ២. មេរៀនមុខងារឧបករណ៍ (Tools) - ដកពាក្យខ្លីៗចោល
    // ---------------------------------------------------------
    ...
    { keys: ['whites', 'white point', 'ចំណុចស'], answer: "⚪ **Whites**: កំណត់ចំណុច 'សបំផុត' នៅក្នុងរូបភាពទាំងមូល។ គេទាញវាឡើងបន្តិច (+) ដើម្បីឱ្យរូបភាពទាំងមូលមើលទៅស្រឡះ (Pop) និងមិនស្លេកស្លាំង។" },
    ...
    { keys: ['copy', 'paste', 'settings', 'ចម្លង', 'កូពី'], answer: "📝 ក្នុងកម្មវិធី Lightroom បងអាចយកការកែប្រែពីរូបមួយ ទៅដាក់រូបមួយទៀតព្រមគ្នាបានរហ័ស៖\n\n១. ចូលទៅរូបដែលកែហើយ ចុចលើសញ្ញា **... (៣គ្រាប់)** > យក **Copy Settings**។\n២. ទៅកាន់រូបថ្មីដែលបងចង់កែ ចុចសញ្ញា **...** នោះដដែល រួចយក **Paste Settings**។ ⏱️⚡" },
    { keys: ['reset', 'ត្រឡប់ទៅដើម', 'កែខុស'], answer: "🔄 បើកែពណ៌ទៅរាងជ្រុលដៃ មិនបាច់ភ័យ! \n\nបងអាចចុចប៊ូតុង **Reset** នៅខាងក្រោម ឬគ្រាន់តែ **ចុចពីរដង (Double-tap)** លើរង្វង់មូលនៃ Slider ណាមួយ នោះវានឹងរត់ត្រឡប់ទៅលេខ 0 វិញភ្លាមៗ។ 💪" },
