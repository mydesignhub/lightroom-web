  ...
  const handleSend = async (text = null) => {
      ...
      try {
          ...
          if (FALLBACK_RESPONSES.includes(response) && apiKey) {
              try {
                  const apiResponse = await callGemini(msg, "អ្នកគឺជាជំនួយការ AI ជាមនុស្សប្រុសរបស់ My Design ជំនាញខាងកែរូបភាពជាមួយកម្មវិធី Lightroom។ សូមឆ្លើយតបជាភាសាខ្មែរយ៉ាងរួសរាយរាក់ទាក់ កម្រិតអាជីព និងត្រូវប្រើពាក្យ 'បាទ' ជាដាច់ខាត (ហាមប្រើពាក្យ ចាស)។");
