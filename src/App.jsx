...
const SUGGESTED_QUESTIONS = [
    "តើកែស្បែកមុខឱ្យសម៉ត់យ៉ាងដូចម្តេច?", "តើពណ៌ក្រហមមានអត្ថន័យយ៉ាងណា?", "តើអ្វីទៅជា Aspect Ratio 4:5?", "របៀបធ្វើឱ្យមេឃពណ៌ខៀវដិត?", 
    "តើ Clone Stamp និង Healing Brush ខុសគ្នាម៉េច?", "តើ Vibrance ខុសពី Saturation យ៉ាងណា?", "ជួយណែនាំ Preset សម្រាប់ថតនៅហាងកាហ្វេ", 
    "តើអត្ថន័យនៃពណ៌ខៀវ (Blue) គឺជាអ្វី?", "តើ Snapshot និង Versions ប្រើធ្វើអ្វី?", "របៀបកែរូបថតពេលយប់កុំឱ្យមាន Noise?", 
    "តើអ្វីទៅជា Golden Hour?", "របៀបបង្កើតពណ៌ Teal & Orange?", "តើ Dehaze ប្រើសម្រាប់ធ្វើអ្វី?", "ណែនាំ Preset សម្រាប់ថត Pre-wedding", 
    "របៀបធ្វើឱ្យរូបភាពច្បាស់ (Sharp)?", "តើ Tone Curve ប្រើដូចម្តេច?", "តើអ្វីទៅជា Rating និង Flag?", "តើ HSL គឺជាអ្វី?", 
    "របៀបធ្វើឱ្យរូបមាន Mood សោកសៅ?", "តើ Calibration ប្រើសម្រាប់អ្វី?", "តើ Chromatic Aberration គឺជាអ្វី?", 
    "តើគួរ Export រូបបែបណាសម្រាប់ Facebook?", "របៀបប្រើ Masking កែតែមេឃ", "ហេតុអ្វីរូបខ្ញុំថតមកងងឹតមុខ?", "តើពណ៌លឿងតំណាងឱ្យអ្វី?",
    "របៀបកែរូបខ្មៅស (B&W) ឱ្យស្អាត", "តើធ្វើម៉េចអោយស្លឹកឈើពណ៌បៃតងខ្មៅ?", "របៀបកែរូបអោយភ្លឺ (Bright & Airy)", "តើ Grain ប្រើដើម្បីអ្វី?", 
    "តើ Vignette គឺអ្វី?", "របៀបកែរូប Portrait ពេលយប់?", "តើ Highlights និង Whites ខុសគ្នាម៉េច?", "តើ Clarity គួរប្រើពេលណា?"
];
...
// Extended Knowledge Base to cover ALL quiz questions, Color Psychology, and friendly detailed explanations.
const KNOWLEDGE_BASE = [
    ...
    { keys: ['green', 'ពណ៌បៃតង', 'បៃតង', 'ស្លឹកឈើ'], answer: "សួស្ដីចាស៎! 💚 ពណ៌បៃតង (Green) តំណាងឱ្យធម្មជាតិ ភាពស្រស់ស្រាយ ការលូតលាស់ និងជីវិតថ្មី។\n\n💡 **គន្លឹះកម្រិតប្រូ (Pro Tip)៖**\nអ្នកថតរូបភាគច្រើនចូលចិត្តធ្វើឱ្យពណ៌ស្លឹកឈើមើលទៅ 'Dark & Moody' ដោយចូលទៅ HSL > Green:\n- ទាញ Green Hue ទៅខាងឆ្វេង (រកពណ៌លឿងបន្តិច)\n- បន្ថយ Green Saturation\n- ទាញ Green Luminance ចុះក្រោម។ ធានាថារូបភាពមើលទៅបែប Cinematic តែម្ដង! 🌿✨" },
    { keys: ['yellow', 'ពណ៌លឿង', 'លឿង'], answer: "សួស្ដីបង! 💛 ពណ៌លឿង (Yellow) គឺជាពណ៌នៃពន្លឺព្រះអាទិត្យ ភាពរីករាយ សុទិដ្ឋិនិយម និងភាពកក់ក្តៅ (Warmth)។\n\n💡 **ក្នុងការកែរូប៖**\nពណ៌នេះដើរតួសំខាន់ណាស់នៅក្នុងការថតរូបពេលរះ ឬពេលលិច (Golden Hour)។ បងអាចទាញ Temp ទៅខាងស្តាំ (ពង្រីកភាពកក់ក្តៅ) និងបន្ថែម Yellow Saturation បន្តិចដើម្បីឱ្យរូបភាពមានពន្លឺជះស្រស់ស្អាត និងមានអារម្មណ៍វិជ្ជមាន! 🌅" },
    { keys: ['orange', 'ពណ៌ទឹកក្រូច', 'ទឹកក្រូច'], answer: "ជម្រាបសួរ! 🧡 ពណ៌ទឹកក្រូច (Orange) ជាពណ៌នៃភាពរស់រវើក ភាពកក់ក្តៅ និងភាពច្នៃប្រឌិត។\n\n💡 **សំខាន់បំផុតក្នុងការកែស្បែក (Skin Tones)៖**\nពណ៌ទឹកក្រូចគឺគ្រប់គ្រងលើពណ៌ស្បែកមនុស្សផ្ទាល់តែម្ដង! បងចង់ឱ្យមុខសម៉ត់ គឺត្រូវចូលទៅ HSL > Orange រួចបង្កើន Luminance និងបន្ថយ Saturation បន្តិច។ កុំភ្លេចក្បួននេះណា៎ វាមានប្រយោជន៍ខ្លាំងណាស់សម្រាប់រូប Portrait! 😍" },
    { keys: ['purple', 'magenta', 'ពណ៌ស្វាយ', 'ស្វាយ', 'ពណ៌ផ្កាឈូក', 'ផ្កាឈូក', 'pink'], answer: "សួស្ដីបង! 💜 ពណ៌ស្វាយ និងផ្កាឈូក តំណាងឱ្យភាពអាថ៌កំបាំង ភាពរ៉ូមែនទិក និងភាពប្រណីត (Luxury)។\n\n💡 **ក្នុងការកែរូប៖**\nច្រើនតែប្រើក្នុងស្តាយបែប Cyberpunk (Teal & Magenta) ឬការថតរូប Fashion។ បងអាចលេងជាមួយឧបករណ៍ Tint ដោយរុញទៅស្តាំ (Magenta) បន្តិច ដើម្បីកាត់បន្ថយពណ៌បៃតងចេញពីស្បែក ឬបង្កើត Mood ប្លែកៗ។ ស្ទីលនេះកំពុងពេញនិយមណាស់! 霓虹" },
    ...
    { keys: ['aspect ratio', '4:5', '16:9', 'ratio', 'ទំហំរូប'], answer: "សួស្ដីបង! 📐 **Aspect Ratio** គឺជាសមាមាត្ររវាងទទឹង និងបណ្ដោយរបស់រូបភាព។\n\n- **៤:៥ (4:5)**: គឺជាទំហំស្តង់ដារល្អបំផុតសម្រាប់ផុសលើ **Instagram (Portrait)** ព្រោះវាបង្ហាញពេញអេក្រង់ទូរស័ព្ទ។\n- **១៦:៩ (16:9)**: គឺជាសមាមាត្រផ្ដេក ពេញនិយមសម្រាប់ការថតវីដេអូ YouTube ឬទម្រង់បែប **Cinematic (ភាពយន្ត)**។\n\nបងចង់ផុសរូបលើបណ្តាញសង្គមមួយណាដែរ ខ្ញុំអាចណែនាំបន្ថែមបានណា៎! 😉" },
    { keys: ['clone stamp', 'healing brush', 'លុបមុន', 'លុបមនុស្ស', 'ស្នាម'], answer: "ជម្រាបសួរ! 🩹 **Healing Brush** និង **Clone Stamp** គឺជាវេទមន្តសម្រាប់ជួសជុលរូបភាព៖\n\n- **Healing Brush**: ល្អបំផុតសម្រាប់ **លុបមុន ឬស្នាម** លើស្បែក ដោយវាចម្លងយកទម្រង់ក្បែរៗនោះមកបិទពីលើ រួចតម្រឹមពណ៌ និងពន្លឺដោយស្វ័យប្រវត្តិ។\n- **Clone Stamp**: ចម្លងវត្ថុទាំងមូលពីកន្លែងមួយទៅកន្លែងមួយទៀតទាំងស្រុង ល្អសម្រាប់លុបវត្ថុរំខានធំៗចេញពីផ្ទៃខាងក្រោយ។\n\nសាកល្បងប្រើវា ដើម្បីឱ្យរូបបងកាន់តែ Perfect! ✨" },
    { keys: ['snapshot', 'versions', 'រក្សាទុកការកែ', 'កត់ត្រា'], answer: "សួស្ដីបង! 📸 តើបងដឹងទេថា **Snapshot (ឬ Versions)** មានប្រយោជន៍អ្វី?\n\nវាជួយបងឱ្យ **រក្សាទុកដំណាក់កាលកែប្រែ (Save State)** នៅវិនាទីណាមួយ។ ឧទាហរណ៍ បងកែបានស្អាតមួយបែបហើយ ចង់សាកកែបែបផ្សេងទៀត តែខ្លាចបាត់កុងមុន បងគ្រាន់តែបង្កើត Snapshot ទុកសិន។ ពេលបងចង់ត្រលប់មកវិញ គ្រាន់តែចុចលើវា គឺមកវិញភ្លាម ដោយមិនបាច់ចុច Undo ហត់ទេ! ងាយៗមែនទែន! 🙌" },
    { keys: ['rating', 'flag', 'ផ្កាយ', 'ទង់', 'សម្គាល់រូប'], answer: "ជម្រាបសួរ! ⭐️ **Rating (ដាក់ផ្កាយ)** និង 🚩 **Flag (ដាក់ទង់)** គឺជាឧបករណ៍ចាត់ចែងរូបភាពកម្រិតប្រូ (Photo Culling)៖\n\n- **Flag**: ប្រើសម្រាប់សម្គាល់រូបដែលត្រូវយក (Pick) ឬ រូបត្រូវបោះចោល (Reject)។\n- **Rating**: ប្រើសម្រាប់ដាក់ពិន្ទុ ១ ដល់ ៥ ផ្កាយ ដើម្បីងាយស្រួលរើសរូបណាដែលស្អាតដាច់គេ (ឧទាហរណ៍ រូប ៥ ផ្កាយទុកធ្វើការងារធំ)។\n\nមានពួកវា គឺស្រួលរៀបចំរាប់ពាន់សន្លឹកដោយមិនវិលមុខទេបង! 📂" },
    { keys: ['export', 'save', 'facebook', 'fb', 'quality', 'sharpen for screen'], answer: "សួស្ដីបង! 🌟 ចង់ Export រូបភាពផុសលើ Facebook ឱ្យច្បាស់ម៉ត់ល្អមែនទេ? នេះជារូបមន្តអាថ៌កំបាំង៖\n\n១. **Format**: ជ្រើសយក JPG\n២. **Quality**: ដាក់ ១០០% តែម្ដង\n៣. **Resize to Fit**: ជ្រើសយក Long Edge រួចវាយលេខ **2048 pixels** (នេះជាទំហំដែល FB មិនព្រិលរូបបង)\n៤. **Output Sharpening**: ធីកលើ **Sharpen for Screen** រួចយក Standard (សម្រាប់ជួយកុំឱ្យបែកពេល Upload)។\n\nសាកល្បងមើលណា៎បង ធានាថាច្បាស់ប្លែកមិត្តភក្តិសួររកក្បួនហើយ! 😎" },
    { keys: ['copy', 'paste', 'settings', 'ចម្លង', 'កូពី'], answer: "ជម្រាបសួរ! 📝 ក្នុង Lightroom បងអាចយកការកែប្រែពីរូបមួយ ទៅដាក់រូបមួយទៀតបានយ៉ាងរហ័ស (Batch Edit):\n\n១. ចូលទៅរូបដែលកែហើយ ចុចលើសញ្ញា **... (៣គ្រាប់)** > យក **Copy Settings**។\n២. ទៅកាន់រូបថ្មីដែលបងចង់កែ ចុចសញ្ញា **...** នោះដដែល រួចយក **Paste Settings**។\n\nវានឹងចម្លងពណ៌ និងពន្លឺទាំងមូលតែម្ដង! លឿន ហើយចំណេញពេលរាប់ម៉ោង! ⏱️⚡" },
    { keys: ['reset', 'ត្រឡប់ទៅដើម', 'កែខុស'], answer: "សួស្ដីបង! 🔄 បើកែទៅរាងជ្រុលដៃ ឬវង្វេងពណ៌ មិនអីទេបង! បងអាចចុចប៊ូតុង **Reset** នៅខាងក្រោម ឬគ្រាន់តែ **ចុចពីរដង (Double-tap)** លើរង្វង់មូលនៃ Slider ណាមួយ នោះវានឹងរត់ទៅលេខ 0 វិញភ្លាមៗ។ កុំខ្លាចក្នុងការសាកល្បងទាញខុសណា៎! រៀនកែរូប គឺត្រូវក្លាហាន! 💪" },
    { keys: ['before', 'after', 'មុន', 'ក្រោយ', 'មើលរូប'], answer: "ជម្រាបសួរ! 👁️ ដើម្បីប្រៀបធៀបរូបភាព បងគ្រាន់តែ **ចុចសង្កត់ (Press and Hold)** លើរូបភាពផ្ទាល់ វានឹងបង្ហាញរូបភាពដើម (Before) រួចដកម្រាមដៃចេញ វានឹងបង្ហាញរូបដែលកែរួច (After)។ ការធ្វើបែបនេះជួយបងកុំឱ្យកែពណ៌ជ្រុលដៃពេក (Over-edited)! ស្អាតប្លែកអត់បង? 😉" },
    { keys: ['raw', 'jpg', 'ប្រភេទឯកសារ'], answer: "សួស្ដីបង! 📁 តើបងធ្លាប់ឆ្ងល់ទេថាហេតុអ្វីជាងថតអាជីពចូលចិត្តថត **RAW**?\n\n- **RAW File**: គឺជាទិន្នន័យស្រស់ៗពីសេនស័រកាមេរ៉ា។ វាផ្ទុកព័ត៌មានពន្លឺ និងពណ៌ច្រើនមហិមា! ពេលបងទាញ Shadows ដែលងងឹតឈឹង វានៅតែឃើញច្បាស់ មិនបែកគ្រាប់។\n- **JPG**: ជារូបដែលកាមេរ៉ាកាត់តរួច (Compressed) វាតូចស្រួលប្រើ តែបងយកមកកែខ្លាំងមិនបានទេ វានឹងបែករូប (Banding)។\n\nបើអាច គួរថត RAW ណា៎បង ការកែប្រែនឹងមានសេរីភាពជាងមុន ១០០ ដង! 📷✨" },

    // --- LIGHT & EXPOSURE TOOLS (QUIZ COVERAGE) ---
    { keys: ['exposure', 'ពន្លឺ'], answer: "សួស្ដីបង! 💡 **Exposure** គឺជាឧបករណ៍សម្រាប់គ្រប់គ្រង **ពន្លឺរួម (Overall Light)** នៃរូបភាពទាំងមូល។\n\n- បើទាញទៅស្ដាំ (+) រូបនឹងភ្លឺឡើង។\n- បើទាញទៅឆ្វេង (-) រូបនឹងងងឹត។\nវាជាជំហានទី ១ ដែលបងត្រូវប៉ះមុនគេបង្អស់ ពេលចាប់ផ្តើមកែរូបមួយសន្លឹក! កុំភ្លេចសារ៉េវាឱ្យត្រូវពន្លឺសិនណា៎! ☀️" },
    { keys: ['contrast'], answer: "ជម្រាបសួរ! 🌗 **Contrast** គឺជាការកំណត់គម្លាតរវាងកន្លែងភ្លឺ និងកន្លែងងងឹត។\n\n- បើដាក់ Contrast ខ្ពស់៖ កន្លែងងងឹតនឹងកាន់តែខ្មៅ កន្លែងភ្លឺកាន់តែភ្លឺ ធ្វើឱ្យរូបភាពមើលទៅរឹងមាំ (Punchy) និងដិតច្បាស់។\n- បើបន្ថយវាទាប៖ រូបភាពនឹងមើលទៅស្រទន់បែបស្រអាប់ៗ (Faded/Vintage look) ល្អសម្រាប់ស្តាយកូរ៉េ។ បងចូលចិត្តបែបណាដែរ? 🤔" },
    { keys: ['highlight', 'whits', 'whites'], answer: "សួស្ដីបង! ☁️ **Highlights** និង **Whites** មើលទៅស្រដៀងគ្នា តែខុសគ្នាណា៎៖\n\n- **Highlights**: គ្រប់គ្រងតែតំបន់ដែលភ្លឺខ្លាំង (ដូចជាមេឃ ឬពន្លឺថ្ងៃជះលើមុខ)។ ភាគច្រើនគេចូលចិត្តបន្ថយវា (-) ដើម្បីសង្គ្រោះពពកឱ្យលេចចេញមកវិញ។\n- **Whites**: កំណត់ចំណុច 'សបំផុត' នៅក្នុងរូបភាពទាំងមូល។ គេទាញវាឡើងបន្តិច ដើម្បីឱ្យរូបភាពមើលទៅស្រឡះ (Pop) កុំឱ្យស្លេក។ សាកសង្កេតពេលទាញវាទាំងពីរមើលបង! ✨" },
    { keys: ['shadow', 'blacks', 'ពណ៌ខ្មៅ'], answer: "ជម្រាបសួរ! 🌑 សម្រាប់ការគ្រប់គ្រងភាពងងឹត យើងមាន **Shadows** និង **Blacks**៖\n\n- **Shadows**: ប៉ះពាល់តែតំបន់នៅក្នុងម្លប់ប៉ុណ្ណោះ។ បើថតបញ្ច្រាស់ថ្ងៃមុខខ្មៅ បងទាញ Shadows បូក (+) មុខនឹងភ្លឺមកវិញវេទមន្តតែម្ដង!\n- **Blacks**: កំណត់ចំណុច 'ខ្មៅបំផុត' ក្នុងរូប។ ការទាញ Blacks ចុះ (-) ជួយឱ្យរូបភាពមានជម្រៅ (Depth) មើលទៅមានទម្ងន់។ ដៃគូទាំងពីរនេះសំខាន់ណាស់! 🎩" },
    { keys: ['tone curve', 'curve', 'ខ្សែកោង'], answer: "សួស្ដីបង! 📈 **Tone Curve** គឺជាអាវុធសម្ងាត់របស់អ្នកកែរូបអាជីព (Pro Retoucher)!\n\nវាជួយគ្រប់គ្រងពន្លឺ និងពណ៌កម្រិតខ្ពស់។ ក្បួនដែលល្បីជាងគេគឺ ការទាញខ្សែកោងឱ្យចេញជារាង **អក្សរ S (S-Curve)** ៖ ទាញចំណុច Highlights ឡើងលើបន្តិច និងទាញ Shadows ចុះក្រោមបន្តិច... បងនឹងទទួលបាន Contrast ដ៏ស្រស់ស្អាតនិងទន់ភ្លន់បំផុត! ហ៊ានសាកល្បងប្រើវាទេបង? 🚀" },

    // --- COLOR & HSL TOOLS (QUIZ COVERAGE) ---
    { keys: ['white balance', 'wb', 'temp', 'tint', 'សីតុណ្ហភាព'], answer: "ជម្រាបសួរ! 🌡️ **White Balance (WB)** សំខាន់បំផុតដើម្បីកំណត់ថាពណ៌ស គឺពិតជាពណ៌សពិតប្រាកដ ឬអត់!\n\nវាមានពីរផ្នែក៖\n១. **Temp (Temperature)**: ប្តូរពណ៌ទៅជា លឿង (ក្តៅ/Warm) ឬ ខៀវ (ត្រជាក់/Cool)។ ប្រើសម្រាប់កែពន្លឺព្រះអាទិត្យ ឬភ្លើងអំពូល។\n២. **Tint**: ប្តូរពណ៌ទៅជា បៃតង (Green) ឬ ស្វាយផ្កាឈូក (Magenta)។ ប្រើដើម្បីកែទម្រូវពណ៌ដែលផ្លាតចេញពីដើមឈើ ឬអំពូល Neon ជាដើម។ ត្រូវកែវាឱ្យត្រូវមុនទាញពណ៌ផ្សេងៗណា៎! ⚖️" },
    { keys: ['vibrance', 'saturation'], answer: "សួស្ដីបង! ✨ ចង់ឱ្យពណ៌ស្រស់ តើគួរប្រើ **Vibrance** ឬ **Saturation** ល្អ?\n\n- **Vibrance**: គឺឆ្លាតណាស់! វាជ្រើសរើសទាញតែពណ៌ណាដែលស្លេក ឱ្យស្រស់ឡើង ដោយមិនប៉ះពាល់ពណ៌ដែលដិតស្រាប់ និង **ការពារមិនឱ្យខូចពណ៌ស្បែកមនុស្ស (Skin tones)** ឡើយ។ ខ្ញុំណែនាំឱ្យបងប្រើវាសម្រាប់រូប Portrait!\n- **Saturation**: វាទាញពណ៌ទាំងអស់ឡើងព្រមគ្នាដោយងងឹតងងុល។ បើទាញខ្លាំង ស្បែកមនុស្សនឹងទៅជាពណ៌លឿងឆេះដូចមានជម្ងឺខាន់លឿងអញ្ចឹង! រាងប្រយ័ត្នបន្តិចណា៎! 🎨" },
    { keys: ['hsl', 'mix', 'លាយពណ៌'], answer: "ជម្រាបសួរ! 🎛️ **HSL / Color Mix** គឺជាបន្ទប់ពិសោធន៍ពណ៌របស់អ្នកកែរូប!\nHSL មកពីពាក្យ៖\n- **H (Hue)**: ប្តូរប្រភេទពណ៌ (ឧ. ប្តូរពណ៌បៃតង ទៅជាពណ៌លឿង)\n- **S (Saturation)**: កំណត់ភាពដិត ឬស្លេករបស់ពណ៌មួយនោះ\n- **L (Luminance)**: កំណត់ភាពភ្លឺ ឬងងឹតរបស់ពណ៌នោះ (ឧ. ធ្វើឱ្យស្បែកមុខភ្លឺស គឺប្រើ Orange Luminance)។\n\nបងចង់ប្តូរពណ៌មួយណាក្នុងរូបដែរពេលនេះ? 🖌️" },
    { keys: ['split toning', 'grading', 'color grading'], answer: "សួស្ដីបង! 🎬 **Color Grading (កាលមុនហៅ Split Toning)** គឺជាតិចនិកធ្វើឱ្យរូបមានស្តាយភាពយន្ត (Cinematic)។\n\nវាអនុញ្ញាតឱ្យបងបាញ់ពណ៌ចូលទៅក្នុងតំបន់ ៣ ផ្សេងគ្នា៖\n- **Shadows**: គេនិយមដាក់ពណ៌ Teal ឬ ខៀវទឹកប៊ិច ឱ្យត្រជាក់ភ្នែក។\n- **Highlights**: គេនិយមដាក់ពណ៌ Orange ឬ លឿង ឱ្យកក់ក្តៅ។\n- ការលាយ Teal & Orange នេះ ធ្វើឱ្យរូបភាពមានសោភ័ណភាព និងអារម្មណ៍កម្រិតហូលីវូដតែម្ដង! សាកមើលបង ធានាថាឡូយ! 🍿" },
    { keys: ['calibration', 'rgb'], answer: "ជម្រាបសួរ! 🎚️ **Calibration** គឺជាអាវុធកម្រិតខ្ពស់សម្រាប់ប្តូរពណ៌គោលរបស់កាមេរ៉ា (Red, Green, Blue Primary)។\n\nអ្នកជំនាញតែងតែចូលមកទីនេះដើម្បីបង្កើតទម្រង់ពណ៌ផ្ដាច់មុខរបស់ពួកគេ (Signature Look)។ ឧទាហរណ៍៖ ទាញ Red Primary Hue ទៅស្តាំ និង Blue Primary Hue ទៅឆ្វេង ដើម្បីបង្កើតពណ៌ Teal & Orange ដ៏ស្រស់ស្អាតបំផុត! នេះជាអាថ៌កំបាំងនៃការបង្កើត Preset ល្បីៗណា៎! 🤫" },

    // --- EFFECTS, DETAIL, & OPTICS (QUIZ COVERAGE) ---
    { keys: ['texture', 'clarity'], answer: "សួស្ដីបង! 💎 ចង់ឱ្យរូបច្បាស់កម្រិតណា? តោះស្គាល់ **Texture** និង **Clarity**៖\n\n- **Texture**: ផ្ដោតលើលម្អិតតូចៗ (Micro-details)។ បើទាញដក (-) វាធ្វើឱ្យស្បែកមុខម៉ត់រលោងស្អាតខ្លាំងណាស់ (Skin Smoothing) ដោយមិនប៉ះពាល់ភ្នែក ឬសក់។\n- **Clarity**: បង្កើន Contrast នៅកម្រិត Midtones។ វាធ្វើឱ្យរូបភាពរឹងមាំ និងមុតស្រួច។ ល្អសម្រាប់ការថតសំណង់អគារ ទេសភាព ឬមនុស្សប្រុស តែបើទាញលើមុខមនុស្សស្រី អាចធ្វើឱ្យមើលទៅចាស់ ឬគ្រើមពេក! ប្រយ័ត្នណា៎! 🧑‍🎨" },
    { keys: ['dehaze', 'អ័ព្ទ', 'fog', 'mist'], answer: "ជម្រាបសួរ! 🌫️ **Dehaze** គឺជាឧបករណ៍កម្ចាត់អ័ព្ទដ៏មានឥទ្ធិពល៖\n\n- ទាញទៅស្តាំ (+)៖ វាសម្លាប់អ័ព្ទ ផ្សែង ឬធូលី ធ្វើឱ្យរូបភាពទេសភាព ឬមេឃដែលស្រអាប់ ក្លាយជាថ្លាឆ្វង់ និងដិតពណ៌មកវិញភ្លាមៗ។\n- ទាញទៅឆ្វេង (-)៖ វាបន្ថែមអ័ព្ទចូលទៅក្នុងរូប បង្កើតជា Mood បែបយល់សប្តិ ឬអាថ៌កំបាំង (Dreamy/Fairy tale)។\nឧបករណ៍នេះក៏ប្រើសម្រាប់បិទបាំងកន្លែងដែលឆេះពន្លឺខ្លាំងបានដែរណា៎! 🌄" },
    { keys: ['vignette', 'គែមងងឹត'], answer: "សួស្ដីបង! ⚫ **Vignette** គឺជាបែបផែនធ្វើឱ្យគែមរូបភាពងងឹត (ឬស)។\n\nមូលហេតុដែលគេប្រើវា គឺដើម្បីទាញចំណាប់អារម្មណ៍ភ្នែកអ្នកមើល ឱ្យផ្ដោតត្រង់ទៅចំណុចកណ្តាលនៃរូបភាព (Subject) ដោយកាត់បន្ថយភាពរំខាននៅជុំវិញគែម។ ជាទូទៅ គេដាក់វានៅខ្ទង់ -10 ទៅ -20 សម្រាប់រូប Portrait គឺមើលទៅមានសិល្បៈណាស់! 👁️" },
    { keys: ['grain', 'គ្រាប់', 'film'], answer: "ជម្រាបសួរ! 🎞️ **Grain** គឺជាការបន្ថែមគ្រាប់អុចៗតូចៗទៅក្នុងរូបភាព ដើម្បីត្រាប់តាមកាមេរ៉ាហ្វីលជំនាន់មុន (Analog Film Look)។\n\nវាជួយឱ្យរូបភាពមើលទៅមានលក្ខណៈសិល្បៈ បុរាណ (Vintage) និងកាត់បន្ថយភាពរលោងពេករបស់កាមេរ៉ាឌីជីថលសម័យថ្មី។ ជួនកាល បើបងកែរូបហើយខូចពណ៌តិចតួច ការរោយ Grain ពីលើក៏អាចជួយបិទបាំងកំហុសបានដែរណា៎! ឆ្លាតមែនទេ? 😉" },
    { keys: ['sharp', 'sharpness', 'ច្បាស់', 'sharpening'], answer: "សួស្ដីបង! 🔪 ដើម្បីធ្វើឱ្យរូបភាពកាន់តែច្បាស់មុតស្រួច (Sharp) បងអាចប្រើឧបករណ៍ **Sharpening**។\n\n💡 **គន្លឹះពិសេស (Pro Trick) សម្រាប់ការថត Portrait**:\nពេលបងទាញ Sharpening កុំភ្លេចប្រើមុខងារ **Masking** (នៅលើកុំព្យូទ័រចុច Alt សង្កត់ រួចអូស slider Masking) ដើម្បីកំណត់ឱ្យវាធ្វើឱ្យច្បាស់តែត្រង់គែមវត្ថុ ឬភ្នែក សក់ប៉ុណ្ណោះ ដោយរក្សាស្បែកមុខឱ្យនៅរលោងដដែល។ បើមិនអញ្ចឹងទេ ស្នាមមុនក៏ច្បាស់មកដែរណា៎! 👁️✨" },
    { keys: ['noise reduction', 'noise', 'luminance noise'], answer: "ជម្រាបសួរ! 🤫 **Luminance Noise Reduction** គឺជាវីរបុរសសង្គ្រោះរូបភាពពេលយប់!\n\nពេលបងថតរូបយប់ងងឹត ហើយប្រើ ISO ខ្ពស់ រូបនឹងចេញគ្រាប់អុចៗសខ្មៅ (Noise) ពេញហ្នឹង។ ការទាញ Luminance ទៅបូក (+) នឹងជួយរំលាយគ្រាប់ទាំងនោះឱ្យម៉ត់រលោងវិញ។ \n⚠️ **ចំណាំ:** កុំទាញខ្លាំងពេក (លើសពី ៤០) ព្រោះរូបភាពនឹងបាត់បង់លម្អិត ហើយមើលទៅដូចរូបជ័រអញ្ចឹង (Plastic look)! ល្មមៗបានហើយបង! 🌃" },
    { keys: ['optics', 'lens correction', 'profile correction', 'chromatic aberration'], answer: "សួស្ដីបង! 📷 **Lens Corrections** គឺបងត្រូវតែបើកជានិច្ចគ្រប់រូបភាពទាំងអស់!\nវាមានពីរចំណុចសំខាន់៖\n១. **Enable Profile Corrections**: កែតម្រូវភាពកោង និងគែមងងឹតដែលបង្កឡើងដោយកែវថត (Lens) របស់បងមកជារូបរាងធម្មតាវិញដោយស្វ័យប្រវត្តិ។\n២. **Remove Chromatic Aberration**: លុបបំបាត់គែមពណ៌ព្រាលៗ (ពណ៌ស្វាយ ឬបៃតង) ដែលច្រើនកើតមាននៅតាមមែកឈើពេលថតបញ្ច្រាស់មេឃភ្លឺ។\nគ្រាន់តែធីក ២ នេះ រូបបងស្អាតឡើងមួយកម្រិតហើយ! 🔍" },
    { keys: ['geometry', 'upright', 'តម្រង់អគារ'], answer: "ជម្រាបសួរ! 📐 **Geometry (Upright)** គឺជាឧបករណ៍ដ៏អស្ចារ្យសម្រាប់ការថតអគារ ស្ថាបត្យកម្ម ឬបន្ទប់ (Real Estate)។\n\nបើបងថតរូបមកឃើញអគារ ឬជញ្ជាំងកោងទោរមិនត្រង់ បងគ្រាន់តែចូលទៅចុចប៊ូតុង **Auto** ឬ **Vertical** ក្នុង Geometry កម្មវិធីនឹងទាញតម្រង់អគារនោះឱ្យឈរត្រង់ភ្លឹង ៩០ ដឺក្រេតែម្ដង ដូចជាងថតអាជីពអញ្ចឹង! 🏢📏" },

    // --- MASKING & SELECTIVE EDITS (QUIZ COVERAGE) ---
    { keys: ['mask', 'masking', 'select sky', 'select subject'], answer: "សួស្ដីបង! 🎭 **Masking** គឺជាការកែប្រែកម្រិតខ្ពស់ ដែលអនុញ្ញាតឱ្យបងកែតែមួយចំណែកនៃរូប ដោយមិនប៉ះពាល់កន្លែងផ្សេង!\n\n- **Select Subject**: កម្មវិធីនឹងគូសយកតែតួអង្គ (មនុស្ស/សត្វ) ដោយស្វ័យប្រវត្តិ ដើម្បីបងអាចទាញពន្លឺឱ្យមនុស្សភ្លឺឡើង។\n- **Select Sky**: គូសយកតែមេឃ។ ងាយស្រួលបំផុតបើចង់ឱ្យមេឃពណ៌ខៀវដិត តែមិនចង់ឱ្យជាប់ពណ៌ដល់មុខមនុស្ស! បងសាកប្រើ Masking មើល រូបភាពនឹងលោតដល់កម្រិត Pro ភ្លាម! 🦸‍♂️" },
    { keys: ['radial gradient', 'linear gradient', 'invert mask'], answer: "ជម្រាបសួរ! 🔘 ក្នុង Masking បងអាចប្រើឧបករណ៍គូសវាសជាច្រើន៖\n\n- **Radial Gradient**: គឺការគូសជារង្វង់។ ឧទាហរណ៍ គូសលើមុខតួអង្គ រួចទាញ Exposure បន្តិចដើម្បីបង្កើតចំណុចលេចធ្លោ (Spotlight)។\n- **Linear Gradient**: គូសជាបន្ទាត់ត្រង់។ ល្អសម្រាប់ការទាញមេឃឱ្យងងឹតបន្តិចនៅផ្នែកខាងលើ ដើម្បីឱ្យរូបមានជម្រៅ។\n- **Invert Mask**: គឺការត្រឡប់តំបន់ដែលបានជ្រើសរើស (ឧ. គូសរង្វង់លើមុខ រួច Invert មានន័យថា វានឹងជ្រើសរើសទីតាំងទាំងអស់ **ក្រៅពីមុខ** វិញ)។ ល្បិចនេះឡូយណាស់ណា៎! 🔄" },

    // --- FIXES ---
    { keys: ['underexposed', 'dark face', 'ងងឹតមុខ'], answer: "សួស្ដីបង! 📸 បើរូបងងឹតមុខ ឬថតបញ្ច្រាស់ថ្ងៃ កុំបារម្ភអី ងាយៗទេ៖\n\n១. សាកល្បងទាញ **Shadows** ឡើង (+) ខ្ទង់ +40 ទៅ +60 ដើម្បីបើកពន្លឺក្នុងម្លប់។\n២. បើវានៅតែមិនគ្រប់គ្រាន់ បងអាចប្រើយុទ្ធសាស្ត្រ **Masking > Radial Gradient** គូសរង្វង់ចំពីលើមុខតួអង្គ រួចទាញ Exposure ឡើងបន្តិច។ ធានាថាមុខភ្លឺស្អាតដូចមានអ្នកកាន់ភ្លើងហ្វាពន្លឺឱ្យអញ្ចឹង! 💡" },
    { keys: ['blurry', 'not sharp', 'មិនច្បាស់'], answer: "ជម្រាបសួរ! 🧐 បើរូបថតមកមិនសូវច្បាស់ បងអាចសង្គ្រោះបានខ្លះៗដោយ៖\n\n១. ចូលទៅ Detail លើក **Sharpening** ឡើងខ្ទង់ +40 ទៅ +60។\n២. ត្រលប់មក Basic លើក **Clarity** បន្តិច (+10 ទៅ +15) ដើម្បីបន្ថែមភាពរឹងមាំឱ្យគែមវត្ថុ។\n⚠️ តែបើវាព្រិលខ្លាំងដោយសាររលាក់ដៃពេលថត (Motion Blur) ឬខុស Focus ខ្លាំង ការកែមិនអាចសង្គ្រោះបាន ១០០% ទេណា៎បង។ រូបដើម (Raw file) សំខាន់ណាស់! 📸" },
    { keys: ['dull', 'flat', 'ស្លេក'], answer: "សួស្ដីបង! 🎨 បើរូបភាពមើលទៅស្លេកៗ គ្មានជីវិត តោះធ្វើឱ្យវាលេចធ្លោឡើងវិញ៖\n\n១. បង្កើន **Contrast** បន្តិច (+15 ទៅ +25)។\n២. ទាញ **Blacks** ចុះ (-) ដើម្បីឱ្យរូបភាពមានស្រមោលកាត់គ្នា និងមានជម្រៅ។\n៣. បង្កើន **Vibrance** (+20) ឱ្យពណ៌ស្រស់រស់រវើកមកវិញដោយសុវត្ថិភាព។ គ្រាន់តែ ៣ ជំហាននេះ រូបបងនឹង Pop ឡើងតែម្ដង! ✨" },
    { keys: ['too bright', 'overexposed', 'ភ្លឺពេក'], answer: "ជម្រាបសួរ! ☀️ បើរូបភាពភ្លឺឆេះពេក បងអាចទាញវាចុះបានយ៉ាងងាយ (ពិសេសបើរូបនោះជា RAW)៖\n\n១. បន្ថយពន្លឺរួមដោយទាញ **Exposure** ចុះ (-0.5 ទៅ -1.0)។\n២. ទាញសង្គ្រោះមេឃ ឬពន្លឺថ្ងៃដោយទាញ **Highlights** ចុះខ្លាំង (-50 ទៅ -100)។\n៣. ទាញ **Whites** ចុះបន្តិចបើសិនជានៅតែឆេះ។ ធានាថាពពកដែលបាត់ នឹងលេចចេញមកវិញ! ☁️" },

    // --- SPECIFIC SCENARIOS & LOOKS ---
    { keys: ['street', 'urban', 'ផ្លូវ', 'ទីក្រុង', 'street photography'], answer: "សួស្ដីបង! 🏙️ សម្រាប់រូបភាព Street Photography ឬទីក្រុង ស្ទីលបែបស្រអាប់ៗ តែរឹងមាំ (Gritty & Contrast) គឺសាកសមបំផុត៖\n\n- **Light**: បង្កើន Contrast (+30), ទាញ Highlights ចុះ (-40) និងបង្កើន Shadows (+30)។\n- **Effects**: បង្កើន Clarity (+20 ទៅ +30) ឱ្យអគារមើលទៅរឹងមាំ។\n- **Color**: បន្ថយ Saturation បន្តិច (-10) ឬប្រើ Color Grading បន្ថែមពណ៌ខៀវក្នុង Shadows ឱ្យមើលទៅបែបភាពយន្ត (Cinematic)! ម៉េចដែរចាប់អារម្មណ៍ស្តាយនេះទេបង? 📸" },
    { keys: ['food', 'delicious', 'អាហារ', 'ម្ហូប', 'ញ៉ាំ'], answer: "ជម្រាបសួរ! 🍔 ដើម្បីកែរូបអាហារឱ្យមើលទៅគួរឱ្យចង់ញ៉ាំ ស្រក់ទឹកមាត់ នេះជាគន្លឹះ៖\n\n១. **White Balance**: កុំឱ្យរូបភាពលឿងពេក ឬខៀវពេក ពណ៌ចានត្រូវតែពណ៌ស! (ចុចយក Auto ក៏បាន)\n២. **Color**: បង្កើន Vibrance (+30) ឱ្យពណ៌បន្លែ សាច់ ស្រស់ស្អាត។ បន្ថែម Red និង Orange Saturation បន្តិច។\n៣. **Details**: បង្កើន Texture (+15) ដើម្បីឱ្យគេឃើញសរសៃសាច់ គ្រឿងទេស ឬភាពស្រួយរបស់អាហារបានច្បាស់។ ឃ្លានបាត់! 🤤" },
    { keys: ['cafe', 'coffee', 'shop', 'ហាងកាហ្វេ', 'កាហ្វេ'], answer: "សួស្ដីបង! ☕ សម្រាប់ការថតរូបលេងនៅហាងកាហ្វេ ស្តាយបែបកក់ក្តៅ និងបែប Minimalist (Warm & Minimal) កំពុងពេញនិយមខ្លាំង៖\n\n- **Temp**: ទាញទៅស្តាំបន្តិច ឱ្យកក់ក្តៅ (Warm tone)។\n- **Contrast**: បន្ថយបន្តិច (-15) ឱ្យរូបភាពស្រទន់ មើលទៅស្រួលភ្នែក។\n- **Color Mix**: បន្ថយ Saturation ពណ៌បៃតង និងខៀវ (Desaturate) ទុកតែពណ៌ទឹកក្រូច លឿង និងត្នោត (ពណ៌ឈើ/កាហ្វេ)។ ផុសទៅបាន Like ច្រើនណាស់! 🤎" },
    { keys: ['wedding', 'pre-wedding', 'prewedding', 'ការងារ'], answer: "ជម្រាបសួរ! 💍 សម្រាប់រូប Pre-wedding ស្តាយកូរ៉េ ដែលគេនិយមប្រើគឺ **Bright & Airy (ភ្លឺ ស្រទន់ និងមានខ្យល់អាកាស)**៖\n\n១. បង្កើន **Exposure** (+0.3 ទៅ +0.7) ឱ្យរូបភ្លឺស្រឡះ។\n២. ទាញ **Shadows** ឡើងខ្លាំង (+40 ទៅ +60) ឱ្យមុខតួអង្គភ្លឺទន់ភ្លន់។\n៣. បន្ថយ **Contrast** (-10 ទៅ -20) និងបន្ថយ **Texture/Clarity** បន្តិច (-10) ដើម្បីឱ្យស្បែកមើលទៅម៉ត់រលោង និងរ៉ូមែនទិក។ ផ្អែមល្ហែមណាស់បង! 🥰" },
    { keys: ['sunset', 'sunrise', 'ថ្ងៃលិច', 'ថ្ងៃរះ', 'golden', 'golden hour'], answer: "សួស្ដីបង! 🌅 រូប Golden Hour ឬថ្ងៃលិច ត្រូវការភាពកក់ក្តៅ និងរ៉ូមែនទិកខ្លាំង៖\n\n- **White Balance**: ទាញ Temp ទៅរកពណ៌លឿង/ទឹកក្រូច (+) ច្រើនបន្តិច។\n- **Light**: ទាញ Highlights ចុះ (-50) ដើម្បីកុំឱ្យឆេះព្រះអាទិត្យ និងទាញ Shadows ឡើង (+40) ឱ្យឃើញទេសភាព។\n- **Color Grading**: ដាក់ពណ៌ទឹកក្រូចក្នុង Highlights ឱ្យពន្លឺព្រះអាទិត្យកាន់តែជះខ្លាំង។ ធានាថាល្អឥតខ្ចោះបង! ✨" },
    { keys: ['portrait', 'មនុស្ស', 'tua'], answer: "ជម្រាបសួរ! 🧑 សម្រាប់ការកែរូប Portrait ឱ្យស្អាតទាក់ទាញ ក្បួនធំបំផុតគឺ **ត្រូវយកតួអង្គជាធំ**៖\n\n១. ត្រូវប្រាកដថាមុខតួអង្គភ្លឺល្អ (ប្រើ Exposure ឬ Radial Mask)។\n២. កែពណ៌ស្បែកឱ្យស៊ីជម្ពូ ដោយប្រើ HSL > Orange (បន្ថយ Saturation, បង្កើន Luminance)។\n៣. បន្ថយ Texture (-15) ដើម្បីធ្វើឱ្យស្បែកមុខរលោងស្អាត ដោយមិនប៉ះពាល់ភាពច្បាស់របស់សក់និងភ្នែក។\n៤. ដាក់ Vignette (-15) ឱ្យគែមងងឹត ដើម្បីឱ្យគេមើលតែតួអង្គ។ ស្អាតកប់ស៊េរី! 📸" },
    { keys: ['landscape', 'scenery', 'ទេសភាព', 'ព្រៃ', 'ភ្នំ'], answer: "សួស្ដីបង! 🏞️ ដើម្បីកែរូបទេសភាព (Landscape) ឱ្យស្រស់ស្អាត ដិតល្អ នេះជាក្បួនប្រចាំត្រកូល៖\n\n១. **ពន្លឺ**: ទេសភាពច្រើនតែមេឃភ្លឺពេក ដីងងឹតពេក។ ដូច្នេះ បងត្រូវទាញ Highlights ចុះ (-60) និងទាញ Shadows ឡើង (+60)។\n២. **ភាពច្បាស់**: បង្កើន Texture និង Clarity ខ្ទង់ +20 ដើម្បីឱ្យដើមឈើ និងថ្មមើលទៅមានទម្រង់ច្បាស់លាស់។\n៣. **ពណ៌**: បង្កើន Vibrance (+30) ដើម្បីឱ្យមេឃ និងពណ៌បៃតងរស់រវើក! បងត្រៀមវ៉ាលីចេញដើរលេងហើយមែនទេ? 😉" },
    
    // --- GREETINGS & GENERAL CONVERSATION ---
    { keys: ['hello', 'hi', 'suesdey', 'សួស្តី', 'សួរ', 'bhat', 'jah', 'love'], answer: "សួស្ដីបងបាទ/ចាស! 👋 ស្វាគមន៍មកកាន់ ម៉ាយឌីហ្សាញ។ ខ្ញុំជាជំនួយការ AI ដ៏ឈ្លាសវៃរបស់អ្នក ដែលមានជំនាញពិសេសខាងកែរូបភាពបែបអាជីពជាមួយ Lightroom។ \n\nតើថ្ងៃនេះបងចង់ឱ្យខ្ញុំជួយពន្យល់ពីឧបករណ៍ណា (ឧទាហរណ៍ Tone Curve, HSL) ឬ ចង់បានរូបមន្ត Preset ស្តាយអីដែរ (ឧទាហរណ៍ Cinematic, កាហ្វេ, Pre-wedding)? ប្រាប់ខ្ញុំមកបានតាមសប្បាយណា៎! 😊✨" },
    { keys: ['thanks', 'orkun', 'អរគុណ'], answer: "មិនអីទេបង! ជួយបានដោយក្ដីរំភើប! ❤️ ខ្ញុំសប្បាយចិត្តណាស់ដែលបានជួយចែករំលែកចំណេះដឹងនេះដល់បង។ \n\nកុំភ្លេចណា៎ ការកែរូបកាន់តែស្អាត គឺអាស្រ័យលើការហាត់អនុវត្តញឹកញាប់ (Practice makes perfect!)។ បើពេលកំពុងកែមានចម្ងល់អី ឬចង់សួរពីបច្ចេកទេសថ្មីៗ បងអាចឆាតសួរខ្ញុំបានរហូតណា៎! សំណាងល្អក្នុងការកែរូបបង! 📸🔥" },
    { keys: ['help', 'ជួយ', 'របៀបប្រើ'], answer: "ជម្រាបសួរ! 🤝 ខ្ញុំនៅទីនេះរង់ចាំជួយបងជានិច្ច! បងអាចសួរខ្ញុំបានរាល់ចម្ងល់ទាំងអស់ទាក់ទងនឹងការកែរូប ដូចជា៖\n\n🎨 **សួរពីរូបមន្តពណ៌**: \"សុំ Preset ហាងកាហ្វេ\" ឬ \"របៀបកែពណ៌ Cinematic\"\n🛠️ **សួរពីឧបករណ៍កែរូប**: \"តើ Dehaze ប្រើសម្រាប់អ្វី?\" ឬ \"របៀបប្រើ Tone Curve\"\n📸 **សួរពីបញ្ហាក្នុងរូប**: \"ហេតុអីថតរូបមកងងឹតមុខ?\" ឬ \"របៀបកែរូបកុំឱ្យមាន Noise\"\n\nគ្រាន់តែសរសេរសំណួររបស់បងមក ខ្ញុំនឹងពន្យល់ប្រាប់យ៉ាងលម្អិត និងងាយយល់បំផុត! តោះ ចាប់ផ្តើម! 🚀" }
];
