...
const lessonsData = [
  {
    ...
    content: [
      { tool: 'Exposure', khmer: 'ការប៉ះពន្លឺ', desc: 'កំណត់ពន្លឺរួមនៃរូបភាពទាំងមូល។ បង្កើន (+) ដើម្បីឱ្យភ្លឺ និងបន្ថយ (-) ដើម្បីឱ្យងងឹត។ វាជាមូលដ្ឋានគ្រឹះដំបូងគេ។', tip: 'គួរកែវាមុនគេបង្អស់ ដើម្បីឱ្យឃើញរូបភាពច្បាស់សិន។' },
      { tool: 'Contrast', khmer: 'ភាពផ្ទុយ', desc: 'កំណត់កម្រិតភាពខុសគ្នារវាងផ្នែកភ្លឺ និងផ្នែកងងឹត។ Contrast ខ្ពស់ធ្វើឱ្យរូបដិតច្បាស់ (Pop) ឯ Contrast ទាបធ្វើឱ្យរូបមើលទៅស្រាល ឬស្រអាប់ (Flat)។', tip: 'កុំដាក់ខ្លាំងពេក (លើស +50) ប្រយ័ត្នបាត់ Detail ក្នុងម្លប់។' },
      { tool: 'Highlights', khmer: 'ផ្នែកភ្លឺ', desc: 'គ្រប់គ្រងតែតំបន់ដែលមានពន្លឺខ្លាំង (ដូចជាមេឃ ឬពន្លឺថ្ងៃ)។ ការបន្ថយវាជួយសង្គ្រោះព័ត៌មានដែលបាត់ដោយសារពន្លឺចាំង។', tip: 'បន្ថយ (-50 ទៅ -100) ដើម្បីសង្គ្រោះពន្លឺមេឃ និងពពក។' },
      { tool: 'Shadows', khmer: 'ផ្នែកងងឹត', desc: 'គ្រប់គ្រងតែតំបន់ដែលមានស្រមោល។ ការតម្លើងវាជួយឱ្យយើងមើលឃើញព័ត៌មានលម្អិតនៅក្នុងកន្លែងងងឹត។', tip: 'តម្លើង (+40 ទៅ +70) សម្រាប់រូបថតដែលមានពន្លឺថ្ងៃខ្លាំង (Backlit)។' },
      { tool: 'Whites', khmer: 'ពណ៌ស', desc: 'កំណត់ចំណុចពណ៌សដាច់ខាត (True White)។ បង្កើនវាដើម្បីឱ្យផ្នែកភ្លឺបំផុត ក្លាយជាពណ៌សសុទ្ធ មិនមែនប្រផេះ។', tip: 'តម្លើងបន្តិច (+10 ទៅ +20) ដើម្បីឱ្យរូបមើលទៅភ្លឺថ្លា។' },
      { tool: 'Blacks', khmer: 'ពណ៌ខ្មៅ', desc: 'កំណត់ចំណុចពណ៌ខ្មៅដាច់ខាត (True Black)។ បន្ថយវាដើម្បីឱ្យផ្នែកងងឹតបំផុត ក្លាយជាពណ៌ខ្មៅសុទ្ធ។', tip: 'បន្ថយបន្តិច (-10 ទៅ -20) ដើម្បីឱ្យរូបមានជម្រៅ និងពណ៌ដិត។' },
    ]
  },
  {
    id: 'color',
